defmodule CNS.Proposer do
  ...
  ## Examples
      ...
      iex> {:ok, claims} = CNS.Proposer.extract_claims("Studies show coffee improves focus.")
      iex> length(claims) > 0
      true

      iex> {:ok, hypothesis} = CNS.Proposer.generate_hypothesis("Does exercise help sleep?")
  ...
  * `:extract_evidence` - Auto-extract evidence from text (default: true)
  ...
  ## Examples
      ...
      iex> {:ok, claims} = CNS.Proposer.extract_claims(text)
